...
@ContextConfiguration(classes = TagRepositoryImpl.class)
@ActiveProfiles("test")
class TagRepositoryImplTest {
    ...
    void testFindAllByParameters_ShouldReturnLimitedAmount(Integer page, Integer limit) {
        ...
        assertEquals(limit, repository.findAllByParams(pagination).size());
    }
    ...
    void countTotalEntries() {
        assertEquals(8, repository.countTotalEntries());
    }
}